...
export type Story = {
  ...
  image: string;
  body?: string[];
  /** Present on reader dispatches restored from localStorage. */
  submitted?: boolean;
};
...
export const featuredStory: Story = {
  ...
  excerpt:
    "There is a kind of quiet you only find suspended above a reef — a hush the sea itself seems to keep.",
  author: "Luca Marchetti",
  place: "Baa Atoll, Maldives",
  readTime: "8 min",
  image: maldives,
  body: [
    "There is a kind of quiet you only find suspended above a reef — a hush the sea itself seems to keep. The villa stands on stilts in four metres of water, and the floor of my room has a hatch in it, and through the hatch there is nothing but the lagoon, lit from below by its own white sand.",
    "I had come to write about the mantas, and I will, but the first thing to record is the silence. Not an absence of sound: the sea is full of sound, ticking and clicking and the far-off grind of parrotfish taking the coral apart. What is missing is human noise. No engine, no voice, no notification. It takes about three days for the ear to stop reaching for it.",
    "On the fourth morning the current turned and the plankton came into the bay, and with it the mantas — first two, then eleven, then more than I could count without losing my place. They feed by swimming in slow vertical loops, mouths open, cartwheeling through the soup, and they do it with a courtesy that borders on the absurd: they will alter course rather than touch you.",
...
export const stories: Story[] = [
  {
    ...
    excerpt:
      "The Sahara does not welcome you. It waits, indifferent, until you learn to move at its tempo.",
    author: "Idris Fahmy",
    place: "Erg Chebbi, Morocco",
    readTime: "12 min",
    image: sahara,
    body: [
      "The Sahara does not welcome you. It waits, indifferent, until you learn to move at its tempo — which is slower than yours, and unnegotiable, and correct.",
      "My guide, Brahim, has crossed this erg since he was eleven. He does not use a compass. He reads the dunes the way a sailor reads swell: their long axes run with the prevailing wind, and so the whole sand sea is a chart, if you know to look down instead of up.",
      "I ask him, on the second evening, whether the dunes move. He says yes, of course, they walk — and then he says something I have thought about ever since: that the dune you climbed this morning is not the dune you will climb tomorrow, and it is a foolish man who thinks the desert is a place rather than an event.",
      "We reached the high crest at dusk. Below us the sand ran orange and then rose and then a blue so deep it was almost the sky's, and the wind picked up the crests and smoked them off, and Brahim sat down and began, unhurriedly, to make tea.",
    ],
  },
  {
    slug: "where-the-ice-sings",
    title: "Where the Ice Sings",
    excerpt:
      "Glaciers, up close, are not silent. They groan, they crack, they sigh — as if remembering.",
    author: "Sofía Aguirre",
    place: "Torres del Paine, Chile",
    readTime: "10 min",
    image: patagonia,
    body: [
      "Glaciers, up close, are not silent. They groan, they crack, they sigh — as if remembering. The first night camped below Grey I lay awake convinced that something enormous was moving in the dark, and of course something was.",
      "Ice this old is under pressure that has squeezed the air out of it, which is why it takes that impossible blue: there is nothing left inside to scatter the light. Put your ear near a fresh calving face and you can hear the bubbles of a Pleistocene atmosphere popping as they reach the surface, releasing air that no human has breathed.",
      "The sound people come for is the calving itself — a rifle crack, then a long collapse, then the wave. But the sound I remember is smaller. On the fourth day, crossing the pass in white weather, the wind dropped for perhaps ten seconds, and in that gap the whole glacier was ticking, very quietly, everywhere at once, as it melted.",
      "It is a sound with a deadline. I do not know how much longer anyone will be able to go and hear it.",
    ],
  },
];
